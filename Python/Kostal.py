...
#urllib2 ist ein Sicherheitsrisiko, deswegen immer urllib.request als urllib2 importieren
...
p = Piko('http://129.69.80.113', 'pvserver', 'PsdOped34')

#print (p.get_current_power())
#print (p.get_l2_voltage())
