function plot_mess_prognose(Prognose_mitError,i)
%UNTITLED2 Summary of this function goes here
%   Detailed explanation goes here
    x = Prognose_mitError.Zeit;
    y1 = Prognose_mitError.Leistung;
    ...
    legend([h1,h2,h3],'Messwert','prognostizierte Wert','probabilistische Wert','Location','northeast')
