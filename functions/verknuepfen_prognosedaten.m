function Prognose_mitError = verknuepfen_prognosedaten(Prognose, GesamtDaten,Methode, Quantile)
    
    index1 = find(GesamtDaten.Zeit == Prognose.Zeit(1));
    index2 =find(GesamtDaten.Zeit == Prognose.Zeit(end));

    CS = GesamtDaten.CS(index1:index2);
    Leistung = GesamtDaten.Leistung(index1:index2);
    Rel = GesamtDaten.Rel(index1:index2);

    Prognose.CS = CS;
    Prognose.Leistung = Leistung;
    Prognose.Rel = Rel;
    Prognose.LeistungPro = Prognose.CS .* Prognose.RelPro;
    Prognose.LeistungError = Prognose.Leistung -Prognose.LeistungPro;
    Prognose.RelError = Prognose.Rel -Prognose.RelPro;
    ...
    elseif Methode ==2
        ...
        Prognose.Quantile_35 = Quantile.Quantile_25 .* Prognose.CS .* RelPro;
        Prognose.Quantile_30 = Quantile.Quantile_30 .* Prognose.CS .* RelPro;
        Prognose.Quantile_45 = Quantile.Quantile_35 .* Prognose.CS .* RelPro;
        Prognose.Quantile_40 = Quantile.Quantile_40 .* Prognose.CS .* RelPro;
        Prognose.Quantile_55 = Quantile.Quantile_45 .* Prognose.CS .* RelPro;
        Prognose.Quantile_50 = Quantile.Quantile_50 .* Prognose.CS .* RelPro;
        Prognose.Quantile_65 = Quantile.Quantile_55 .* Prognose.CS .* RelPro;
        Prognose.Quantile_60 = Quantile.Quantile_60 .* Prognose.CS .* RelPro;
        Prognose.Quantile_75 = Quantile.Quantile_65 .* Prognose.CS .* RelPro;
        Prognose.Quantile_70 = Quantile.Quantile_70 .* Prognose.CS .* RelPro;
        Prognose.Quantile_85 = Quantile.Quantile_75 .* Prognose.CS .* RelPro;
        Prognose.Quantile_80 = Quantile.Quantile_80 .* Prognose.CS .* RelPro;
        Prognose.Quantile_95 = Quantile.Quantile_85 .* Prognose.CS .* RelPro;
        Prognose.Quantile_90 = Quantile.Quantile_90 .* Prognose.CS .* RelPro;
        Prognose.Quantile_05 = Quantile.Quantile_95 .* Prognose.CS .* RelPro;
